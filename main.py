...
bot = Client(
    ...
    bot_token=os.environ.get(
        "BOT_TOKEN", "6671692787:AAGSL--QD5lc5-bsmvR-dEP6hccRN8kPu58"
    ),
...
async def shell(client, message: Message):
    ...
    if len(result) > 2000:
        ...
        await message.reply_text(
            "Output is too large (Sending it as File)", quote=True
        )
    ...
    [
        [
            InlineKeyboardButton(
                text="Devloper", url="https://t.me/Mohitag24"
            ),
...
async def account_login(bot: Client, m: Message):
    ...
    if user is not None and user not in sudo_users:
        ...
        if input.document:
            ...
            await editable.edit(
                "**ENTER A HIGHLIGHTER OTHERWISE SEND 👉CO👈 **")
            ...
            try:
                for i in range(count - 1, len(links)):
                    ...
                    V = links[i][1].replace("file/d/",
                                             "uc?export=download&id=").replace("www.youtube-nocookie.com/embed",
                                                                               "youtu.be").replace(
                    ...
                    if "visionias" in url:
                        ...
                        url = requests.get(
                            f'https://api.classplusapp.com/cams/uploader/video/jw-signed-url?url={url}', headers={
                                'x-access-token': 'eyJhbGciOiJIUzM4NCIsInR5cCI6IkpXVCJ9..hM33P2ai6ivdzxPPfm01LAd4JWv-vnrSxGXqvCirCSpUfhhofpeqyeHPxtstXwe0'}).json()['url']
